...
ogc = gc; ogr = gr;
load("benchmark_aarch64_UMA.mat")
...
ogc = gc;
load("codesize_aarch64_UMA.mat")
subplot(3,2,5)
plot(d, gc, d, ogc, d, uc)
title("Ascon-p Codesize vs. masking order (aarch64)")
xlabel("masking order")
